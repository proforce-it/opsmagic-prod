...
namespace App\Http\Controllers\Api\Workers\Dashboard;
    ...
    public function index(Request $request) {
        try {
            ...
            return self::responseWithSuccess('Dashboard details fetched successfully.', [
                ...
                'confirm_shift' => $this->preparedDashboardShiftData($confirmShift),
                'cancelled_shift' => $this->preparedDashboardShiftData($cancelledShift)
            ]);
        } catch (\Exception $e) {
