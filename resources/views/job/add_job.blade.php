                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-5">
                                                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                                                        ...
                                                                        <input type="text" name="shift_time[]" id="shift_time_1" class="form-control shift_time" placeholder="Enter shift time" value="{{ date('H').':'.date('m').':'.date('s').' - '.date('H').':'.date('m').':'.date('s') }}" />
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-4">
                                                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                                                    ...
                                                                    <input type="number" name="experience" id="experience" class="form-control" placeholder="Experience" value="" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row pb-10">
                                                            <div class="col-lg-12">
                                                                <div class="d-flex align-items-center">
                                                                    <label class="form-check form-check-inline me-5 is-invalid">
                                                                        <input type="checkbox" class="form-check-input skill" name="skill[]" id="skill_check_list_picking" value="picking">
                                                                        <span class="fw-bold ps-2 fs-6">Picking</span>
                                                                    </label>
                                                                    <label class="form-check form-check-inline me-5 is-invalid">
                                                                        <input type="checkbox" class="form-check-input skill" name="skill[]" id="skill_check_list_packing" value="packing">
                                                                        <span class="fw-bold ps-2 fs-6">Packing</span>
                                                                    </label>
                                                                    <label class="form-check form-check-inline me-5 is-invalid">
                                                                        <input type="checkbox" class="form-check-input skill" name="skill[]" id="skill_check_list_forklift_truck_driver" value="forklift truck driver">
                                                                        <span class="fw-bold ps-2 fs-6">Forklift truck driver</span>
                                                                    </label>
                                                                    <label class="form-check form-check-inline me-5 is-invalid">
                                                                        <input type="checkbox" class="form-check-input skill" name="skill[]" id="skill_check_list_production_line" value="production line">
                                                                        <span class="fw-bold ps-2 fs-6">Production line</span>
                                                                    </label>
                                                                    <label class="form-check form-check-inline me-5 is-invalid">
                                                                        <input type="checkbox" class="form-check-input skill" name="skill[]" id="skill_check_list_other" value="other">
