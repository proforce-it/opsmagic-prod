...
@section('title', 'Bookings uploader')
                                            ...
                                            <div class="fv-row">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="fv-row fv-plugins-icon-container">
                                                            <label for="shift_file" class="fs-1 fw-bold mb-5">ADD BOOKINGS</label>
                                                            <input type="file" name="shift_file" id="shift_file" class="form-control">
                                                            <span class="text-danger error" id="shift_file_error"></span>
                                                        </div>
                                                        ...
                                                        <div class="fv-row fv-plugins-icon-container">
                                                            <label for="shift_file" class="fs-6 fw-bold mt-5">Treat bookings as</label>
                                                            <select name="booking_as" id="booking_as" class="form-select form-select-lg" data-control="select2" data-allow-clear="true" data-placeholder="Select...">
                                                                <option></option>
                                                                <option value="Confirmed placements" selected>Confirmed placements</option>
                                                                <option value="Worker invitations">Worker invitations</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row mt-3">
                                                    <div class="col-lg-12 d-flex justify-content-center">
                                                        <div class="fv-row fv-plugins-icon-container">
                                                            <button type="submit" class="btn btn-primary mt-7" id="formSubmitButton">Upload</button>
                                                            <a href="{{ url('job-shift-uploader') }}" class="btn btn-secondary mt-15 d-none" id="reloadThisPage"> Refresh </a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="fv-row fv-plugins-icon-container">
                                                        ...
                                                        <table class="table p-0">
                                                            <tr class="fs-5 fw-bold">
                                                                <td class="p-0">1.</td>
                                                                <td class="p-0 ps-3">Confirmation or invitation emails will be sent to workers based on you ‘treat bookings as’ selection above</td>
                                                            </tr>
                                                            <tr class="fs-5 fw-bold">
                                                                <td class="p-0">2.</td>
                                                                <td class="p-0 ps-3">You can also add bookings visually using the <a href="{{ url('assignment-management') }}">bookings calendar</a> and clicking through to the ‘view bookings’
                                                                    page for a specific date</td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                                </div>
...
@section('js')
    <script>
        $("#download_sample_file").on('click', function (){
           window.location.href="{{ asset('workers/sample_file/bookings.csv') }}"
        });
        ...
        $('#download_csv').on('click', function() {
            ...
            downloadLink.download = 'Import-report.csv';
