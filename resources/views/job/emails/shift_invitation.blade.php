        ...
        <tr>
            <td align="left" valign="center">
                <div style="text-align:left; margin: 0 20px; padding: 40px; background-color:#ffffff; border-radius: 6px">
                    ...
                    <div style="padding-bottom: 30px">{{ config('app.name') }} are offering you a shift on the following job {{ $invitation->job_name }} for {{ $invitation->client_name }}</div>
                    ...
                    <div style="padding-bottom: 30px">Please let us know if you are happy to accept the shift as soon as possible</div>
                    <div style="padding-bottom: 30px"><a style="color: #76B929" href="{{ $invitation->accept_link }}">Yes, I accept the shift</a></div>
                    <div style="padding-bottom: 30px"><a style="color: #E60A7E" href="{{ $invitation->declined_link }}">No, I do not accept the shift</a></div>
