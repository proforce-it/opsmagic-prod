<div class="card card-bordered card-shadow">
    ...
    <div class="card-body">
        <table class="table align-middle table-sm m-0 p-0">
            ...
            <tr class="border-top-3 border-gray-400" id="workers_worked_greater_than_12_days_2_border">
                <td class="text-gray-400 workers_worked_greater_than_12_days_2_class">
                    WORKED >12 DAYS IN A ROW. <br>
                    <div>
                        <a href="{{ url('worker-management?filter=workers-have-worked-greater-than-12-days-in-a-row-2') }}" id="workers_worked_greater_than_12_days_2_view_btn" class="url_modified">
                            <span class="fw-bolder fs-xxl-1 text-gray-400 workers_worked_greater_than_12_days_2" id="workers_worked_greater_than_12_days_2">0</span>
                            <i class="fs-xxl-1 las la-fire-alt float-end text-gray-400 workers_worked_greater_than_12_days_2"></i>
                        </a>
                    </div>
                </td>
            </tr>
