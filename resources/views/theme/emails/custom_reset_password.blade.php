                ...
                <tr>
                    <td align="left" valign="center">
                        <div style="text-align:left; margin: 0 20px; padding: 40px; background-color:#ffffff; border-radius: 6px">
                            ...
                            <div style="padding-bottom: 30px">You recently requested a password reset for your {{ config('app.name') }} user account. Please click the link to reset your password</div>
                            ...
                            <div style="padding-bottom: 30px">If you did not request a password reset you can safely ignore this email</div>
