                        ...
                        <div id="kt_content_container" class="container-xxl">
                            <div class="mb-10">
                                <div class="bg-gray-500 p-10 fs-3 text-white rounded" id="screen_title">
                                    <h4 class="mb-0 fw-boldest text-white fs-1">Add accommodation site</h4>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-body">
                                    <form class="w-100 pb-10" novalidate="novalidate" id="create_accommodation_form">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                                                        ...
                                                                        <input type="text" name="number_of_spaces" id="number_of_spaces" class="form-control" placeholder="Number of spaces" value="0" />
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                                                        <label for="what_three_words_locator" class="fs-6 fw-bold">
                                                                            ...
                                                                            <a href="https://what3words.com/" target="_blank" id="go_to_w3_site">go to site <i class="las la-external-link-square-alt text-primary"></i></a>
                                                                        </label>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                                                        ...
                                                                        <input type="text" name="contact_name" id="contact_name" class="form-control" placeholder="Jane Smith" value="" />
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text" class="form-control" name="contact_number" id="contact_number" placeholder="Telephone">
                                                                        </div>
...
@section('js')
    ...
    <script>
        ...
        $("#create_accommodation_form").on('submit', function (e) {
            $(".error").html('');
            e.preventDefault();
            $.ajax({
                type        : 'post',
                url         : '{{ url('store-accommodation') }}',
                data        : new FormData($("#create_accommodation_form")[0]),
                contentType : false,
                processData : false,
                cache       : false,
