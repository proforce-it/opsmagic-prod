    ...
    <div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-color: #4E618F;">
        ...
        <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
            ...
            <div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
                <!--begin::Form-->
                <form class="form w-100" id="create_password_form" method="post">
                    {{ csrf_field() }}
...
<!--                        <div class="text-gray-400 fw-bold fs-4">Already have reset your password ? <a href="{{ url('/') }}" class="link-primary fw-bolder">Sign in here</a></div>-->
                    ...
                    <div class="text-center">
                        <!--begin::Submit button-->
                        <button type="submit" id="create_password_submit_btn" class="btn btn-lg btn-primary w-100 mb-5">
                            <span class="indicator-label">Create Password</span>
                        </button>
                        <button type="button" class="btn btn-lg btn-primary w-100 mb-5 disabled d-none" data-kt-stepper-action="submit" id="create_password_process_btn">
                            <span>Please wait...
...
@section('create_password_js')
    <script>
        $("#create_password_form").on('submit', function (e) {

            $("#create_password_submit_btn").addClass('d-none');
            $("#create_password_process_btn").removeClass('d-none');
            ...
            $.ajax({
                ...
                success     : function (response) {
                    ...
                    $("#create_password_submit_btn").removeClass('d-none');
                    $("#create_password_process_btn").addClass('d-none');
