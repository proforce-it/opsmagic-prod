                                        ...
                                        <div class="lozenges">
                                            <div class="lozenge">
                                                <div class="lozenge-rate-details">
                                                    ...
                                                    <div class="lozenge-rate-amounts">
                                                        P: £<span id="default_rate_pay_amount">{{ number_format($pay_rate_map['base_pay_rate'], 2) }}</span>
                                                        C: £<span id="default_rate_charge_amount">{{ number_format($pay_rate_map['base_charge_rate'], 2) }}</span>
                                                    </div>
                                                </div>
                                            ...
                                            @if($extra_pay_rate_map->isNotEmpty())
                                                @foreach($extra_pay_rate_map as $eprm)
                                                    <div class="lozenge lozenge-{{ $eprm['color'] }}" id="lozenge_{{ $eprm['id'] }}">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            $("#prm_calendar_save_form").on('submit', function (e) {
                ...
                $.ajax({
                    type        : 'post',
                    url         : '{{ url('store-prm-calendar-event') }}',
                    data        : formData,
                    contentType : false,
                    processData : false,
                    cache       : false,
