<div class="d-none" id="rtw_tab">
    <!--begin::Table container-->
    <div class="table-responsive">
        <div class="p-5">
            <div class="row mb-5">
                <div class="col-lg-12 text-start fw-bolder fs-5 text-uppercase gs-0 border-bottom border-4">ADD A RIGHT TO WORK</div>
            </div>
            <div id="right_to_work_section">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="mb-10 fv-row fv-plugins-icon-container">
                            <!--<label for="right_to_work_1" class="fs-6 fw-bold">Right to work</label>-->
...
{{--                                            </svg>--}}
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <a href="javascript:;" id="add_worker_next_screen_btn" data-add_worker_screen_name="Documents" data-add_worker_no_of_screen="4" data-section="3" class="btn btn-primary btn-lg">Next</a>
                    </div>
                </div>
    ...
    <script>
        ...
        $(document).on('change', '.rtw_drp', function (){
            ...
            if (value === 'UK Citizen') {
                ...
                expiry_date_section.show();
                document_scan_section.show();
            } else if (value === 'Tier 2 (skilled visa)' || value === 'Tier 5 (Seasonal Worker Scheme)' || value === 'Tier 5 (Seasonal Worker Scheme - Poultry)') {
                ...
                expiry_date_section.show();
                document_scan_section.show();
            } else if (value === 'Indefinite leave to remain.') {
