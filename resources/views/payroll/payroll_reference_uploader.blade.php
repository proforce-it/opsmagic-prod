...
@section('title', 'Payroll reference uploader')
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="fv-row fv-plugins-icon-container">
                                                            <label for="payroll_reference_file" class="fs-1 fw-bold mb-5">UPLOAD NEW PAYROLL REFERENCES</label>
                                                            <input type="file" name="payroll_reference_file" id="payroll_reference_file" class="form-control">
                                                            <span class="text-danger error" id="payroll_reference_file_error"></span>
                                                        </div>
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-lg-12 d-flex justify-content-center">
                                                        <div class="fv-row fv-plugins-icon-container">
                                                            ...
                                                            <a href="{{ url('payroll-reference-uploader') }}" class="btn btn-secondary mt-15 d-none" id="reloadThisPage"> Refresh </a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="fv-row fv-plugins-icon-container">
                                                        ...
                                                        <table class="table p-0">
                                                            <tr class="fs-5 fw-bold">
                                                                <td class="p-0">1.</td>
                                                                <td class="p-0 ps-3">Payroll numbers will be added to matching associate records and any errors reported.</td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                                </div>
...
@section('js')
    <script>
        $("#download_sample_file").on('click', function (){
            window.location.href="{{ asset('workers/sample_file/payroll_reference_number.csv') }}"
        });
        ...
        $("#formSubmit").on('submit', function (e) {
            ...
            $.ajax({
                type        : 'post',
                url         : '{{ url('upload-payroll-reference-number') }}',
