    ...
    return {
        init: function() {
            (e = document.querySelector("#kt_modal_create_account")) && new bootstrap.Modal(e), t = document.querySelector("#kt_create_account_stepper"), i = t.querySelector("#kt_create_account_form"), o = t.querySelector('[data-kt-stepper-action="submit"]'), s = t.querySelector('[data-kt-stepper-action="next"]'), (r = new KTStepper(t)).on("kt.stepper.changed", (function(e) {
                6 === r.getCurrentStepIndex() ? (o.classList.remove("d-none"), o.classList.add("d-inline-block"), s.classList.add("d-none")) : 6 === r.getCurrentStepIndex() ? (o.classList.add("d-none"), s.classList.add("d-none")) : (o.classList.remove("d-inline-block"), o.classList.remove("d-none"), s.classList.remove("d-none"))
                ...
                $.ajax({
                    ...
                    data        : new FormData($("#kt_create_account_form")[0]),
                    contentType : false,
                    processData : false,
                    cache       : false,
                    ...
                    "Valid" === t ? (e.preventDefault(), o.disabled = !0, o.setAttribute("data-kt-indicator", "on"),
                        $.ajax({
                            ...
                            success     : function (response) {
                                ...
                                if(response.code === 200) {
                                    setTimeout(function() { window.location.href='worker-management'; }, 1500);
                                }
